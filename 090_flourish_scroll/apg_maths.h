...
*/
static inline bool frustum_vs_aabb( const vec4* frustum_planes, aabb_t box ) {
...
static inline bool frustum_vs_aabb_extra_check( const vec4* frustum_planes, const vec3* frustum_points, aabb_t box ) {
