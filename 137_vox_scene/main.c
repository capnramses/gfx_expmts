/*
 * Voxel Raycast a Scene with voxel-correct depth writing.
 * Anton Gerdelan, 27 Dec 2025.
 *
 * RUN
 * =================================
    ...
    {                                           // Floor tiles
      for ( int z = 0; z < 8; z++ ) {
        for ( int x = 0; x < 8; x++ ) {
          ...
          mat4 T      = translate_mat4( (vec3){ xx, yy, zz } );
          mat4 R      = rot_x_deg_mat4( 90 );
