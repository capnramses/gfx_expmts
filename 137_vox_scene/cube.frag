...
void main() {
  ...
  Light lights[3] = Light[3](
    Light( vec3( 2.0, 6.0, 20.0 ), vec3( 0.9, 0.02, 0.305 ), vec3( 0.8 ) ),
    Light( vec3( -2.0, 5.0, -20.0 ), vec3( 0.035, 0.9, 0.02 ), vec3( 0.9 ) ),
    Light( vec3( -1, 20.0, 1.0 ), vec3( 0.03, 0.025, 0.9 ), vec3( 0.7 ) )
  );
