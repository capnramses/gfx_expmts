...
#define SHADER_BINDING_VN 3       /* 4th channel used to store 'heightmap surface' factor of 1 or 0 */
...
void draw_mesh( shader_t shader, mat4 P, mat4 V, mat4 M, uint32_t vao, size_t n_vertices ) {
