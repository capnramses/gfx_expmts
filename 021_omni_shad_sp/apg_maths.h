...
vec4 mult_mat4_vec4 (mat4 mm, vec4 v);
// determinant
...
inline vec4 mult_mat4_vec4 (mat4 mm, vec4 v) {
	// 0x + 4y + 8z + 12w
	float x = mm.m[0] * v.v[0] + mm.m[4] * v.v[1] + mm.m[8] * v.v[2] + mm.m[12] *
		v.v[3];
	// 1x + 5y + 9z + 13w
	float y = mm.m[1] * v.v[0] + mm.m[5] * v.v[1] + mm.m[9] * v.v[2] + mm.m[13] *
		v.v[3];
	// 2x + 6y + 10z + 14w
	float z = mm.m[2] * v.v[0] + mm.m[6] * v.v[1] + mm.m[10] * v.v[2] +
		mm.m[14] * v.v[3];
	// 3x + 7y + 11z + 15w
	float w = mm.m[3] * v.v[0] + mm.m[7] * v.v[1] + mm.m[11] * v.v[2] +
		mm.m[15] * v.v[3];
